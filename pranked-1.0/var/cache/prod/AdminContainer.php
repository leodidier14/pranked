...
class AdminContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'pranked_db', 'user' => 'root', 'password' => '', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => 'D:\\wamp64\\www\\pranked-shop\\pranked-1.0\\modules\\productcomments\\src\\Entity']);
        $d->addExcludePaths([0 => 'D:\\wamp64\\www\\pranked-shop\\pranked-1.0\\modules\\productcomments\\src\\Entity/index.php']);
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => 'D:\\wamp64\\www\\pranked-shop\\pranked-1.0\\modules\\ps_checkout\\src\\Entity']);
        $e->addExcludePaths([0 => 'D:\\wamp64\\www\\pranked-shop\\pranked-1.0\\modules\\ps_checkout\\src\\Entity/index.php']);

        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => 'D:\\wamp64\\www\\pranked-shop\\pranked-1.0\\src\\PrestaShopBundle\\Entity']), 'PrestaShop');
        ...
        $a->setProxyDir('D:\\wamp64\\www\\pranked-shop\\pranked-1.0/var/cache/prod\\/doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_fcb552438f9bfaccfbd7e43a4bfe6159c9578ee8b078bf8b14437744fa3d3203');
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, 'D:\\wamp64\\www\\pranked-shop\\pranked-1.0/var/cache/prod\\/localization');
    }
    ...
    {
        $this->services['prestashop.core.localization.cldr.datalayer.locale_cache'] = $instance = new \PrestaShop\PrestaShop\Core\Localization\CLDR\DataLayer\LocaleCache(${($_ = isset($this->services['prestashop.core.localization.cldr.cache.adapter']) ? $this->services['prestashop.core.localization.cldr.cache.adapter'] : ($this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, 'D:\\wamp64\\www\\pranked-shop\\pranked-1.0/var/cache/prod\\/localization'))) && false ?: '_'});
    ...
    {
        return $this->services['ps_checkout.logger.directory'] = new \PrestaShop\Module\PrestashopCheckout\Logger\LoggerDirectory('1.7.7.0', 'D:\\wamp64\\www\\pranked-shop\\pranked-1.0');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.root_dir' => 'D:\\wamp64\\www\\pranked-shop\\pranked-1.0/app',
            'kernel.project_dir' => 'D:\\wamp64\\www\\pranked-shop\\pranked-1.0',
            'kernel.name' => 'app',
            'kernel.debug' => false,
            'kernel.environment' => 'prod',
            'kernel.cache_dir' => 'D:\\wamp64\\www\\pranked-shop\\pranked-1.0/var/cache/prod\\',
            ...
            'ps_cache_dir' => 'D:\\wamp64\\www\\pranked-shop\\pranked-1.0/var/cache/prod\\',
            ...
            'doctrine.orm.proxy_dir' => 'D:\\wamp64\\www\\pranked-shop\\pranked-1.0/var/cache/prod\\/doctrine/orm/Proxies',
